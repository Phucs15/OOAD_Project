...
public class DashboardFrame extends JFrame {
    ...
    public DashboardFrame() {
        ...
        summaryPanel.add(createRevenueInfoBoxWithTable(revenueQuery,new Color(50, 205, 50)));
    ...
    private JPanel createRevenueInfoBoxWithTable(String query, Color backgroundColor) {
        JPanel panel = new JPanel(new BorderLayout()) {
            @Override
            protected void paintComponent(Graphics g) {
                super.paintComponent(g);
        ...
        JLabel titleLabel = new JLabel("Total Revenue", SwingConstants.CENTER);
